      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-12 ${isArabic ? 'direction-rtl text-right' : ''}`}>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src="/images/logo.png" alt="Donia Restaurant" className="w-10 h-10 rounded-full object-cover border border-gold/30" />
              <div>
                <span className="font-display text-xl font-bold text-white tracking-wide">DONIA</span>
                <span className="block text-[10px] font-handwriting tracking-widest text-white/50">RESTAURANT</span>
              </div>
            </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center">
          <p className="text-white/40 text-xs">
            &copy; {year} Donia Restaurant. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
